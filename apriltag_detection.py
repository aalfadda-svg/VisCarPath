...
class AprilTagDetector:
    ...
    def __init__(self, tag_family: str = "tag36h11", 
                 quad_decimate: float = 2.0,   # CHANGED (Lalo 6/11): was 1.0 - halves detection resolution for ~2x FPS, negligible accuracy loss at our tag size
        ...
        self.tag_size = 0.165  # CHANGED (Lalo 6/11): was 0.08 - our printed tag (test_tag.png) is 165mm. Wrong size = all PnP distances scaled wrong ('perfect distance' bug). Measure the printed black square and update if printer rescaled it.
